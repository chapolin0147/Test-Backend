    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="{{route('api.store')}}"
                  method="POST">
                @csrf
                <input id="ds_codigo" name="ds_codigo" type="hidden" value="">
                <div class="mb-2">
                    <label for="ds_name" class="form-label">Nome</label>
                    <input class="form-control" id="ds_name" required name="ds_name" type="text" value="">
                </div>
                <div class="mb-2">
                    <label for="ds_url" class="form-label">URL</label>
                    <input class="form-control" id="ds_url" required name="ds_url" type="text" value="">
                </div>
                <div class="mb-2">
